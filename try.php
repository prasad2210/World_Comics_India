...
if (isset($_GET['id']) && $_GET['id'] !='') {
    ...
    if ($query_stmt->rowCount() > 0) {
      ...
      ';
        ...
        $query = 'SELECT * FROM `comics` WHERE `id` < 99999999999 AND `lang` = "0" ORDER BY RAND() LIMIT 2';
        $query_stmt = $db_app->prepare($query);
        $query_stmt->execute();
            ...
            <div class="col-md-2">
              <div class="dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                  <a class="dropdown-item" href="./comics.php">None</a>
    ...
    ';
        ...
        $query = 'SELECT * FROM `comics` WHERE `category` = :type1 AND `lang` = "0" ORDER BY RAND() LIMIT 9';
        $query_stmt = $db_app->prepare($query);
