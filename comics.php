...
if(isset($_GET['id']) && $_GET['id'] !=''){
  ...
  $query = 'SELECT * FROM `comics` WHERE `id` < 99999999999 ORDER BY RAND() LIMIT 9';
  $query_stmt = $db_app->prepare($query);
  $query_stmt->execute();
  // echo 2;
            ...
            $extra .= '
              <div class="col-md-4">
                <div class="card" style="border:none !important;">
                  ...
                  <div class="card-body">
                    <a href="https://cybersalamat.com/comics.php?id='.$last_id.'" class="btn btn-primary" style="margin-top:-12%">READ MORE</a>
                  </div>
                </div>
              </div>
              ';
